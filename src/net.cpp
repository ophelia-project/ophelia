...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ophelia " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"opheliatools.com", "dnsseed.opheliatools.com"},
    {"opheliapool.org", "dnsseed.opheliapool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"opheliatools.com", "testnet-seed.opheliatools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ophelia is probably already running."), addrBind.ToString().c_str());
        else
